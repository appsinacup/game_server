...
[🔗](https://github.com/appsinacup/game_server/blob/v1.0.7/lib/game_server/notifications.ex#L1)
...
```elixir
@spec get_notification(Ecto.UUID.t()) ::
  GameServer.Notifications.Notification.t() | nil
```
