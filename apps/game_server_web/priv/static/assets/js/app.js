(() => {
  ...
  var setTheme = (theme) => {
    ...
    document.cookie = "phx_theme=" + actualTheme + "; path=/; max-age=31536000; SameSite=Lax";
  };
  var storedTheme = localStorage.getItem("phx:theme");
  ...
  var setCardCollapsed = (cardEl, collapsed) => {
    if (collapsed) {
...
`
  ...
  // ../../../_build/dev/phoenix-colocated/game_server_web/index.js
  var hooks = {};
  ...
  var Hooks2 = {
    ...
    NavbarAutohide: {
      mounted() {
        ...
        this.dismissBtn.className = "btn btn-ghost btn-circle btn-sm ml-1 opacity-60 hover:opacity-100 transition-opacity";
        ...
        this.toggleBtn.className = "fixed top-3 right-3 z-[60] btn btn-circle btn-sm bg-base-100/60 backdrop-blur-sm border-base-content/10 shadow-md opacity-0 pointer-events-none transition-opacity duration-300";
