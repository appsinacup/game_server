    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <div class="mx-auto max-w-sm lg:max-w-4xl space-y-4">
        ...
        <div :if={local_mail_adapter?()} class="alert alert-info">
          ...
          <div>
            <p>{dgettext("auth", "You are running the local mail adapter.")}</p>
            <p>
              {dgettext("auth", "To see sent emails, visit")}
              <.link href="/dev/mailbox" class="underline">{dgettext("auth", "the mailbox page")}</.link>.
            </p>
          </div>
        </div>
        ...
        <div class="divider">{dgettext("auth", "or continue with")}</div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          >
            ...
            {dgettext("auth", "Sign in with Discord")}
          </.link>
          ...
          >
            ...
            {dgettext("auth", "Sign in with Apple")}
          </.link>
          ...
          >
            ...
            {dgettext("auth", "Sign in with Facebook")}
          </.link>
          ...
          >
            ...
            {dgettext("auth", "Sign in with Steam")}
          </.link>
        </div>
      </div>
    </Layouts.app>
