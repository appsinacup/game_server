...
- [changed] **Theme config fallback**: `THEME_CONFIG` is now optional. The host ships a default theme JSON under `apps/game_server_host/theme/`, and `THEME_CONFIG` acts as a runtime override instead of a requirement.
